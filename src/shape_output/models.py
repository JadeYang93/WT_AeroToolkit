"""Data contracts for the standalone shape output module."""
...
@dataclass(frozen=True)
class ShapeOutputInput:
    """Inputs required by MATLAB P7 shape output."""
...
@dataclass(frozen=True)
class ShapeOutputOptions:
    """Runtime options for shape output generation."""
