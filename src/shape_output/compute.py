"""Core geometry generation for MATLAB P7 shape output."""

from __future__ import annotations

import numpy as np

from .models import AirfoilProfileSet, ShapeOutputInput, ShapeOutputOptions, ShapeOutputResult
...
def build_shape_output(data: ShapeOutputInput, options: ShapeOutputOptions | None = None) -> ShapeOutputResult:
    """Compute blade shape output data from GEO and airfoil profiles."""
